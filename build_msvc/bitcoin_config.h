...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Earthcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Earthcoin Core"
...
#define PACKAGE_NAME "Earthcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Earthcoin Core 0.17.99"
